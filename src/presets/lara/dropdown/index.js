...
export default {
  root: ({ props, state }) => ({
    class: [
      ...
      {
        "outline-none outline-offset-0 ring ring-gray-300/[.3]": state.focused,
      },
      ...
      size(props),
      "min-h-[36px] text-md placeholder:text-md",
    ],
  }),
  input: ({ props }) => ({
    class: [
      ...
      "border-0",
      {
        "text-gray-800 dark:text-white/80": props.modelValue != undefined,
