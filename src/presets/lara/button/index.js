export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Link Button
      { "text-brand-600 bg-transparent border-transparent": props.link },
      ...
      {
        "text-brand-500 border border-brand-500 hover:bg-brand-300/20":
      ...
      {
        "text-gray-500 dark:text-gray-300 border border-gray-500 hover:bg-gray-300/20":
      ...
      // Link
      {
        "focus:ring-brand-400/50 dark:focus:ring-brand-300/50": props.link,
      },
