export default {
  ...
  container: ({ props, state }) => ({
    class: [
      ...
      { "ring ring-brand-400/50 dark:ring-brand-300/50": state.focused },
      { "ring ring-brand-400/50 dark:ring-brand-300/50": state.hovered },
      // Transition
  ...
  input: ({ props }) => ({
    class: [
      ...
      "text-gray-700 dark:text-white/80",
      {
        "bg-gray-0 dark:bg-gray-900": !props.multiple,
    ...
    class: [
      ...
      // Colors
      {
        ...
        "text-brand-700 dark:text-white/80":
          context.focused && context.selected,
        "bg-brand-100 dark:bg-brand-400": context.focused && context.selected,
        "text-brand-700 dark:text-white/80":
          !context.focused && context.selected,
        "bg-brand-50 dark:bg-brand-300": !context.focused && context.selected,
      },
